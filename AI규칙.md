...
#### 지기방 · 채팅 항목 표시 풀 정본 목록 (`chat-assistant.js`와 동일 순서)

아래는 **지출 38개 + 수입 7개** 전부다. 프롬프트·후보 보강은 이 문자열만 사용한다.

**지출 (`CHAT_DISPLAY_EXPENSE_POOL`) — 38**
